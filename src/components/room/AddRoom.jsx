      ...
      <section className="block my-21 max-w-2xl mx-auto">
        <div>
          <div className="bg-[#F3EFE6] items-center py-4 px-3 rounded-3xl inset-shadow-sm inset-shadow-gray-400 drop-shadow-xl/40 space-y-3">
            <h2 className="flex ml-2 pb-3 items-start font-semibold md:text-3xl sm:text-2xl">
              Add a New Room
            </h2>
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-3">
                <label
                  htmlFor="roomType"
                  className="flex font-medium flex-row text-base items-start ml-2"
                >
                  Room Type
                </label>
              ...
              <label
                htmlFor="roomPrice"
                className="flex font-medium text-base items-start ml-2 pt-5"
              >
                Room Price
              </label>
